...
The complex variant includes mean differences, expressed in terms of Cohen's d. It also experiments with higher TPRs, up to 3. Higher real TPRs and larger tail sizes produce fewer observed TPRs below 1.
